...
CONVERSATIONAL_BEHAVIORS = [
    ...
    "accept", "acclaim", "acknowledge", "advise", "agree_with", "alert",
    "allow", "apologize_to", "appease", "applaud", "appreciate",
    "approve_of", "assure", "bless", "brief", "calm", "caution",
    "cheer", "cheer_up", "commend", "compliment", "compromise_with",
    "concur_with", "confess_to", "confide_in", "congratulate", "console",
    "consult", "converse_with", "convince", "cooperate_with", "correct",
    "counsel", "debrief", "discuss_something_with", "encourage", "endorse",
    "entreat", "excuse", "explain_something_to", "extol", "flatter",
    "forgive", "glorify", "greet", "hail", "have_a_heart_to_heart_talk_with",
    "humor", "inform", "inspire", "invite", "joke_with", "laud",
    "negotiate_with", "notify_of_something", "please", "praise",
    "prompt", "propose_marriage_to", "reason_with", "reassure",
    "recount_something_to", "remind", "reply_to", "retell_something_to",
    "share_something_with", "suggest_something_to", "support", "sweet_talk",
    "sympathize_with", "teach", "tell_something_to", "thank", "toast",
    "urge", "vouch_for", "warn", "welcome",

    # --- Negative speech acts ---
    "accuse", "badger", "bawl_out", "belittle", "berate", "bicker_with",
    "blame", "browbeat", "censure", "chew_out", "chide", "condemn",
    "criticize", "curse", "defame", "demean", "denigrate", "denounce",
    "deprecate", "deride", "disapprove_of", "discourage", "discredit",
    "disparage", "disrespect", "gossip_with", "harangue", "heckle",
    "insult", "intimidate", "lie_to", "malign", "misinform", "mislead",
    "mock", "nag", "needle", "patronize", "provoke", "ridicule",
    "scoff_at", "scold", "shame", "slander", "taunt", "tease",
    "tell_off", "tell_to_shut_up", "threaten", "talk_down_to",

    # --- Questions and requests ---
    "ask", "ask_about", "ask_about_something", "ask_for_a_loan", "ask_out",
    "beg", "beseech", "cross_examine", "cry_for", "demand", "implore",
    "insist_something_to", "interrogate", "interview", "plead_with",
    "query", "question", "quiz", "request_something_from",
    "seek_advice_from",

    # --- Directives and commands ---
    "boss", "challenge", "charge_with_something", "command", "confront",
    "dare", "dissuade", "forbid", "goad", "incite", "instruct",
    "lecture", "order", "preach_to", "proselytize", "rebuke",
    "reprimand", "reproach", "summon",

    # --- Agreement, disagreement, and negotiation ---
    "argue_with", "bargain_with", "concede_to", "contradict",
    "debate_with", "deny", "disagree_with", "dismiss", "dispute",
    "haggle_with", "oppose", "persuade", "quibble_with", "rebuff",
    "refuse", "reject", "renounce",

    # --- Informational and narrative ---
    "admit", "analyze", "claim_something_to", "confound", "confuse",
    "convey_something_to", "fib_to", "profess_ones_innocence_to",
    "protest_ones_innocence_to", "report", "sell_something_to",
    "show_something_to", "speak_to", "state_something_to",
    "sexually_proposition",

    # --- Speaking style / manner ---
    "babble_to", "banter_with", "blabber_to", "bluff", "butter_up",
    "cajole", "call", "chat_with", "chatter_to", "coax",
    "complain_about", "complain_to", "confer_with", "drone_on_at",
    "grouse_at", "holler_at", "hush", "interrupt", "jest", "josh",
    "kid", "meet", "mouth_off_to", "mumble_to", "murmur_to",
    "parody", "pester", "pooh_pooh", "quiet", "rant_at",
    "say_farewell_to", "say_goodbye_to", "scream_at", "shout_at",
    "shush", "silence", "sing_to", "stammer_at", "stutter_at",
    "talk_to", "wheedle", "whine_to", "whisper_to", "yell_at",

    # --- High activity / excitement ---
    "alarm", "amaze", "dazzle", "excite", "shock", "surprise",

    # --- Low activity / calm ---
    "comfort", "listen_to", "soothe", "understand",

    # --- Miscellaneous conversational ---
    "appeal_to", "be_sarcastic_toward", "disbelieve", "distrust",
    "punish", "respect", "trust",
]
